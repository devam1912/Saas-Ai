...
const Hero = () => {
  ...
  return (
    ...
    <div className='text-center mb-6'>
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-l m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools. Write articles, generate images and enhance your workflow.</p>
    </div>
    ...
    <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600 '>
        <img src={assets.user_group} alt="" className='h-8' /> Trusted by 19k+ people
    </div>
    </div>
  )
}
